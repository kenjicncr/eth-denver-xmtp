...
export const transactionReferenceContentTypeConfig: ContentTypeConfiguration = {
    ...
    processors: {
        [ContentTypeTransactionReference.toString()]: [processTransactionReferenceRequest],
    },
    validators: {
        [ContentTypeTransactionReference.toString()]: isValidTransactionReferenceContent,
    },
};
